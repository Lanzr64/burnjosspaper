...
public class PaginationContainer extends AbstractContainerMenu {
    ...
    private ItemStack blockItem = createBlockItem();
    private ItemStack indexItem = new ItemStack(Items.COMPASS);

    private static ItemStack createBlockItem() {
        ItemStack stack = new ItemStack(Items.GLASS_PANE);
        stack.set(DataComponents.CUSTOM_NAME, Component.literal("Empty"));
        return stack;
    }
